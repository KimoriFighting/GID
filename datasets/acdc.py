...
if __name__ == '__main__':
    input_folder = '/mnt/disk/yongsen/Semantic_Segmentation/pro_ACDC/training'
    preprocessing_folder = '/mnt/disk/yongsen/Semantic_Segmentation/pro_ACDC/preproc_data'

    # d=load_and_maybe_process_data(input_folder, preprocessing_folder, '3D', (116,116,28), (2.5,2.5,5))
    data = load_and_maybe_process_data(input_folder, preprocessing_folder, '2D', (256, 256), (1.36719, 1.36719))
