...
def test(args, rnd):
    ...
    # state = torch.load('./save/GID_R50_UDF_{}'.format(
    #                rnd), map_location=device)
    state = torch.load('/mnt/disk/yongsen/code/Semantic_Segmentation/LCLT/Student/82_14', map_location=device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pre_path', type=str,
                        default='/search/hadoop04/jiangxinfa/yongsen/GID/save/transformerL_UDF_199.pth')
